(function (blink) {
	...
	var mackay_demoStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	mackay_demoStyle.prototype = {
		bodyClassName: 'content_type_clase_mackay_demo',
		ckEditorStyles: {
			name: 'mackay_demo',
			styles: [
				...
				{ name: 'Desplegable', type: 'widget', widget: 'blink_dropdown', attributes: { 'class': 'mackay_demo-dropdown' } },
				{ name: 'Desplegable 2', type: 'widget', widget: 'blink_dropdown', attributes: { 'class': 'mackay_demo-dropdown-2' } },
		...
		animateNavbarOnScroll: function () {
			...
			$('.js-slider-item').scroll(function () {
                ...
                changeHighBar: function () {
                    if($('.mackay_demo-navbar').length>0 && $('.navbar').length>0){
                        blink.theme.setTopByHeight('.navbar', '.mackay_demo-navbar');
                    }
                }
	};

	mackay_demoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), mackay_demoStyle.prototype);

	blink.theme.styles['mackay_demo'] = mackay_demoStyle;
